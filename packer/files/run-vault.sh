...
function generate_vault_config {
  ...
  local readonly enable_auto_unseal="$7"
  local readonly auto_unseal_project="${8}"
  local readonly auto_unseal_region="${9}"
  local readonly auto_unseal_key_ring="${10}"
  local readonly auto_unseal_crypto_key="${11}"
  local readonly enable_ui="${12}"
...
# HA settings
cluster_addr  = "https://active.vault.service.$instance_region.consul:$cluster_port"
api_addr      = "https://active.vault.service.$instance_region.consul:$port"
